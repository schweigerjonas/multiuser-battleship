 ...
 * @author Fiedler
 */
public class Radioknopf extends JRadioButton implements Aktionsfaehig{
    private JComponent gruppe;
    public Radioknopf(){
        groesseSetzen(120,24);
    }
    /**
     * Übergabe der Beschriftung des Knopfes
     */
    public Radioknopf(String text){
        setText(text);
        groesseSetzen(120,24);
    }
    ...
    public void gewaehltSetzen(boolean gewaehlt){
    ...
    public void gruppeSetzen(JComponent c){
        gruppe = c;
    }
    public JComponent gruppeGeben(){
        return gruppe;
    }
}
